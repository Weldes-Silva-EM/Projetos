    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                Console.WriteLine("Substraction: {0}", intOperation.Multiply(numbers));
                Console.WriteLine("Multiplication: {0}", intOperation.Multiply(numbers));
                ...
                Console.WriteLine("Multiplication: {0}", doubleOperation.Multiply(doubleNumbers));
